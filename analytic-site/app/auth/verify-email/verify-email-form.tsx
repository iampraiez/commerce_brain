...
export function VerifyEmailForm({ companyId, callbackUrl }: VerifyEmailFormProps) {
  ...
  if (!companyId) {
    return (
      <Card className="p-6 text-center max-w-md border border-destructive/20 mx-auto">
  ...
  if (success) {
    return (
      <Card className="p-6 text-center border border-border bg-card mx-auto">
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-2 text-center">Verify Your Email</h1>
      ...
      <Card className="p-6 border border-border bg-card">
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          ...
          >
            {resendLoading ? <Loader2 className="w-4 h-4 animate-spin mx-auto" /> : "Resend email"}
          </button>
        </div>
      </Card>
    </div>
