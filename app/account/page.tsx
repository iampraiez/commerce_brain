      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-start justify-between mb-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-primary mb-1">Welcome, {session.user.name || "User"}</h1>
          ...
          <Card className="md:col-span-1">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="font-semibold text-sm">{session.user.name || "Not provided"}</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-wide">Email</p>
                <p className="font-semibold text-sm break-all">{session.user.email}</p>
              </div>
              {session.user.role === "admin" && (
                <div className="pt-4 border-t border-border">
                  <Button asChild className="w-full bg-primary text-primary-foreground hover:bg-primary/90 text-xs">
